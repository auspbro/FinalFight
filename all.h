...
public:
	...
	virtual int Get_weapx()	{ MessageBox(NULL, "virtual int Get_weapx()出错", "ds", MB_OK); return 0; }
	virtual int Get_weapy()	{ MessageBox(NULL, "virtual int Get_weapy()出错", "ds", MB_OK); return 0; }
...
void SetSound( const char*, const char*, const char* );						// 设置声音
